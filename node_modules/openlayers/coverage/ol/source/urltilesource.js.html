...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/urltilesource.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> urltilesource.js
    </h1>
    <div class='clearfix'>
 ...
 * @api
 */
ol.source.UrlTile.prototype.getTileUrlFunction = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.tileUrlFunction;</span>
};
&nbsp;
&nbsp;
/**
...
ol.source.UrlTile.prototype.useTile = function(z, x, y) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.tileCache.containsKey(tileCoordKey)) {
