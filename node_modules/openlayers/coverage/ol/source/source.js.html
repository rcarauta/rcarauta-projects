 ...
 */
ol.source.Source.prototype.setProjection = <span class="fstat-no" title="function not covered" >function(projection) {</span>
<span class="cstat-no" title="statement not covered" >  this.projection_ = projection;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
