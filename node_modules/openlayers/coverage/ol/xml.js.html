 ...
 */
ol.xml.getAttributeNodeNS = <span class="fstat-no" title="function not covered" >function(node, namespaceURI, name) {</span>
<span class="cstat-no" title="statement not covered" >  return node.getAttributeNodeNS(namespaceURI, name);</span>
};
&nbsp;
&nbsp;
/**
