...
<html lang="en">
<head>
    <title>Code coverage report for ol/featureoverlay.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">ol/featureoverlay.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">78.9% <small>(86 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">ol/</a> &#187; featureoverlay.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.FeatureOverlay');
&nbsp;
...
&nbsp;
  if (goog.isDef(options.features)) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (goog.isArray(options.features)) {
      this.setFeatures(new ol.Collection(options.features.slice()));
    } else {
<span class="cstat-no" title="statement not covered" >      goog.asserts.assertInstanceof(options.features, ol.Collection,</span>
          'options.features should be an ol.Collection');
<span class="cstat-no" title="statement not covered" >      this.setFeatures(options.features);</span>
    }
  } else {
 ...
 * @private
 */
ol.FeatureOverlay.prototype.handleImageChange_ = <span class="fstat-no" title="function not covered" >function(event) {</span>
<span class="cstat-no" title="statement not covered" >  this.render_();</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @private
 */
ol.FeatureOverlay.prototype.handleMapPostCompose_ = <span class="fstat-no" title="function not covered" >function(event) {</span>
<span class="cstat-no" title="statement not covered" >  if (goog.isNull(this.features_)) {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
<span class="cstat-no" title="statement not covered" >  var styleFunction = this.styleFunction_;</span>
<span class="cstat-no" title="statement not covered" >  if (!goog.isDef(styleFunction)) {</span>
<span class="cstat-no" title="statement not covered" >    styleFunction = ol.style.defaultStyleFunction;</span>
  }
<span class="cstat-no" title="statement not covered" >  var replayGroup = /** @type {ol.render.IReplayGroup} */</span>
      (event.replayGroup);
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(goog.isDef(replayGroup),</span>
      'replayGroup should be defined');
<span class="cstat-no" title="statement not covered" >  var frameState = event.frameState;</span>
...
<span class="cstat-no" title="statement not covered" >  var squaredTolerance = ol.renderer.vector.getSquaredTolerance(resolution,</span>
      pixelRatio);
<span class="cstat-no" title="statement not covered" >  var i, ii, styles, featureStyleFunction;</span>
<span class="cstat-no" title="statement not covered" >  this.features_.forEach(<span class="fstat-no" title="function not covered" >function(feature) {</span></span>
<span class="cstat-no" title="statement not covered" >    featureStyleFunction = feature.getStyleFunction();</span>
<span class="cstat-no" title="statement not covered" >    styles = goog.isDef(featureStyleFunction) ?</span>
        featureStyleFunction.call(feature, resolution) :
        styleFunction(feature, resolution);
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!goog.isDefAndNotNull(styles)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    ii = styles.length;</span>
<span class="cstat-no" title="statement not covered" >    for (i = 0; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      ol.renderer.vector.renderFeature(replayGroup, feature, styles[i],</span>
...
ol.FeatureOverlay.prototype.setFeatures = function(features) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!goog.isNull(features)) {
